...
Revision ID: 337eae0f4d3d
Revises: 
Create Date: 2020-07-23 15:36:25.387416
...
def upgrade():
    ...
    sa.Column('value', sa.Enum('student', 'professor', 'recruiter', name='userrole'), nullable=True),
    ...
    sa.Column('value', sa.Enum('entry', 'intermediate', 'experienced', 'advanced', 'expert', name='joblevel'), nullable=True),
    sa.Column('country', sa.String(), nullable=True),
    ...
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('course_id', sa.Integer(), nullable=True),
    sa.Column('value', sa.Enum('enrolled', 'taught', 'done', name='coursestatus'), nullable=True),
    sa.ForeignKeyConstraint(['course_id'], ['courses.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
